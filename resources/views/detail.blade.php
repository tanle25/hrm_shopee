            ...
            <div class="w-full px-4 mb-8 md:w-1/2 md:mb-0">
                <div class="sticky top-0 overflow-hidden ">
                    {{-- <div class="relative mb-6 lg:mb-10 lg:h-96">
                        ...
                        <img class="object-contain w-full lg:h-full"
                            src="https://down-vn.img.susercontent.com/file/{{$product->image}}" alt="">
                        ...
                        <div class="w-1/2 p-2 sm:w-1/4">
                            <a class="block border border-gray-200 hover:border-blue-400 dark:border-gray-700 dark:hover:border-blue-300"
                                ...
                                <img class="object-contain w-full lg:h-28"
                                    src="https://down-vn.img.susercontent.com/file/{{$image->image}}" alt="">
                            </a>
                        </div>
                        @endforeach
                    ...
                    <div class="swiper-wrapper sticky top-0">
                        {{-- @if ($product->video)
                        <div class="swiper-slide ">
                            <div class="" style="width: 305px">
                                <video class="object-contain lg:h-full" controls muted>
                        ...
                        @foreach ($product->images as $image)
                        <div class="swiper-slide ">
                            <img class="object-contain w-full lg:h-full" src="https://down-vn.img.susercontent.com/file/{{$image->image}}" />
                        </div>
                        @endforeach
                ...
                <div thumbsSlider="" class="swiper mySwiper">
                    <div class="swiper-wrapper">
                        {{-- @if ($product->video)
                        <div class="swiper-slide " style="height: 128px">
                            <video class="object-contain w-full lg:h-full" muted src="{{$product->video->url}}"></video>
                        </div>
                        @endif --}}
                         @foreach ($product->images as $image)
                        <div class="swiper-slide ">
                            <img class="object-contain w-full lg:h-28" src="https://down-vn.img.susercontent.com/file/{{$image->image}}" />
                        </div>
                        @endforeach
                ...
                <div class="lg:pl-20">
                    <div class="mb-6 ">
                        {{-- <span
                            ...
                            Arrival</span> --}}
                        <h2
                            class="max-w-xl mb-6 text-xl font-semibold leading-loose tracking-wide text-gray-700 md:text-2xl dark:text-gray-300">
                            {{$product->name}}
                        </h2>
                        ...
                        <p class="inline-block text-2xl font-semibold text-gray-700 dark:text-gray-400 ">
                            <span>{{number_format($product->price/100000)}} - {{number_format($product->max_price/100000)}}</span>
                            <span
                                class="ml-3 text-base font-normal text-gray-500 line-through dark:text-gray-400">{{number_format($product->price_min_before_discount/100000)}} - {{number_format($product->price_max_before_discount/100000)}}</span>
                        </p>
                    </div>
                    @foreach ($product->variants as $variant )
                    <div class="mb-8">
                        <h2
                            class="pb-1 mb-4 text-lg font-semibold  dark:text-gray-400">
                            {{$variant->name}}</h2>
                        <div class="border-b border-t py-3 border-blue-300 dark:border-gray-600">
...
<section class="pb-10 font-poppins dark:bg-gray-800">
    <div class="max-w-6xl px-4 mx-auto">
        <h3 class=" dark:text-gray-200 w-full bg-slate-400 p-3 text-lg mb-5">MÔ TẢ SẢN PHẨM</h3>
        {{-- <p class=" dark:text-gray-200 whitespace-break-spaces">{{$product->content}}</p> --}}
        <div class="dark:text-gray-200 whitespace-break-spaces">
            {{-- {!!$product->content!!} --}}
            {!!$desc!!}
        </div>
